...
request_token_url = 'http://localhost:7080/plugins/servlet/oauth/request-token'
access_token_url = 'http://localhost:7080/plugins/servlet/oauth/access-token'
authorize_url = 'http://localhost:7080/plugins/servlet/oauth/authorize'

data_url = 'http://localhost:7080/rest/api/2/issue/BSD-1'
